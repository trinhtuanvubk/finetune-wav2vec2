...
'''NOTE
- This class help to fix double size when using 'resume'
- The bug come from loading and saving 2 time scheduler
'''

class Wrap_OneCycleLR(LRScheduler):
